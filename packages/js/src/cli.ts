...
const HELP = `jev — TypeSafe Jev (System One) decision layer for agent harnesses
...
Usage:
  jev route --goal <text> [--pattern id] [--level L1|L2|L3] [--files f1,f2] [--json]
  jev retrieve --query <text> --passages <file.json> [--top N] [--json]
  jev guard --text <text|-> --side input|output [--policy strict|permissive] [--json]
  jev classify --trace <file.jsonl> [--json]
  jev turn --goal <text> [--message <text>] [--json]
  jev doctor [--json]
